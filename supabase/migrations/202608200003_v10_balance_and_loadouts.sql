-- LOOT LAUNCH v10: balanced safe/risk lanes and real loadout abilities.
...
begin
  ...
  insert into public.launch_sessions(
    ...
    v_user,v_seed,'sky_route_v3',
    jsonb_build_object(
      'layout_version',3,'seed',v_seed,'route_islands',4,
      'safe_coin_value',15,'risk_coin_value',25,
      'allowed_events',array['coin','crystal','bounce','treasure','ability','portal','destructible']
    ),
  ...
  return jsonb_build_object(
    ...
    'EnergyCost',1,'MaxCoins',500,'MaxCrystals',5
  );
end $$;
