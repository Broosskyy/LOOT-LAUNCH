-- LOOT LAUNCH v12: server-seeded route variants, island contracts and boosters.
...
begin
  ...
  insert into public.launch_sessions(
    ...
    v_user,v_seed,'sky_route_v4',
    jsonb_build_object(
      'layout_version',4,'seed',v_seed,'route_variant',abs(v_seed % 3),
      'route_islands',4,'island_contract_targets',array[2,2,3],
