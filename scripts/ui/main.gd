...
func _begin_launch(session:Dictionary,pvp:bool,number:int):
	...
	launch_instruction=_label("LAUFE ZUR KANONE",22,Color.WHITE,HORIZONTAL_ALIGNMENT_LEFT);launch_instruction.position=Vector2(110,148);launch_instruction.size=Vector2(720,72);hud.add_child(launch_instruction)
	launch_route_label=_label("●  ○  ○  ○  ○  ○",19,C_GOLD,HORIZONTAL_ALIGNMENT_RIGHT);launch_route_label.position=Vector2(655,148);launch_route_label.size=Vector2(238,65);hud.add_child(launch_route_label)
