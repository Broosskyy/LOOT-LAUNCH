...
func _run() -> void:
	...
	for _i in range(24):
		...
		await process_frame
	_save(viewport, "res://artifacts/screenshots/v27_iteration_a_hero_models.png")
	...
	for _i in range(12):
		...
		world._update_camera(0.033)
		await process_frame
	_save(viewport, "res://artifacts/screenshots/v27_iteration_b_environment_models.png")
	for _i in range(8):
		world._process(0.033)
		world._update_camera(0.033)
		await process_frame
	_save(viewport, "res://artifacts/screenshots/v27_model_quality_final.png")
	print("V27 model screenshots saved")
	quit(0)
