...
func _run() -> void:
	...
	for _i in range(24):
		...
		await process_frame
	_save(viewport, "res://artifacts/screenshots/v23_iteration_a.png")
	...
	for _i in range(12):
		...
		world._update_camera(0.033)
		await process_frame
	_save(viewport, "res://artifacts/screenshots/v23_iteration_b.png")
	_save(viewport, "res://artifacts/screenshots/v23_reference_composition.png")
	_save(viewport, "res://artifacts/screenshots/v23_initial_spawn.png")
	world.debug_advance_to_island(1)
	for _i in range(24):
		world._process(0.033)
		world._update_camera(0.033)
		await process_frame
	_save(viewport, "res://artifacts/screenshots/v23_after_island_transition.png")
	world._set_state(world.HopState.ENTERING)
	world._update_camera(0.033)
	for _i in range(8):
		world._process(0.033)
		world._update_camera(0.033)
		await process_frame
	_save(viewport, "res://artifacts/screenshots/v23_route_view.png")
	print("V23 composition screenshots saved")
	quit(0)
