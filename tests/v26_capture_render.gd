...
func _run() -> void:
	...
	for _i in range(24):
		...
		await process_frame
	_save(viewport, "res://artifacts/screenshots/v26_iteration_a_materials.png")
	world.target_orbit_yaw += 3.0
	world.orbit_yaw = world.target_orbit_yaw
	for _i in range(12):
		world._process(0.033)
		world._update_camera(0.033)
		await process_frame
	_save(viewport, "res://artifacts/screenshots/v26_iteration_b_lighting.png")
	for _i in range(8):
		world._process(0.033)
		world._update_camera(0.033)
		await process_frame
	_save(viewport, "res://artifacts/screenshots/v26_render_quality_final.png")
	print("V26 render screenshots saved")
	quit(0)
